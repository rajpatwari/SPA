<%-- 
    Document   : district
    Created on : Jan 2, 2013, 1:38:57 PM
    Author     : user1
--%>
...
<html>
    <head>
        ...
        <title>SHALEY POSHAN AHAR - District Master</title>
        ...
        <style type="text/css">
            ...
            #district button{color: cornflowerblue;}
        ...
        <!-- Data File -->
        <script type="text/javascript" src="JS/inward.js"></script>
    </head>
    <body>
        <div id="el1" style="padding: 10px;" class="x-hide-display">
            ...
            <label id="mlabel">Inward Module</label>
