        ...
        <table align="center">  
			<tr>		
	            <td width="100" height="68">
	            	<table>
	            		<tr>
		            		<td width="0"  height="40"><span class="noprint">पावती क्र. </span></td>
		            		<td><span class="fontMarathiNumber16"><%=sectionWiseItemSum.getChallanNumber()%></span></td>
	            		</tr>
	            	</table>
	            </td>
	            <td width="1100" class="center"><span class="noprint">शालेय पोषण आहार धान्यादी मालाची पोहोच पावती</span></td>
	            <td width="800">
	            	<table>
	            		<tr>
		            		<td width="700"><span class="noprint">दिनांक</span>&nbsp;</td>
		            		<td width="100">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="fontsize16"><font face="Kiran"><%=dd%></font>/<font  face="Kiran"><%=mm%></font>/<font face="Kiran"><%=yy%></font></span></td>
	            		</tr>
	            	</table>
	            </td>
			</tr>
			<tr><td colspan="3" class="fontsize12"><span class="noprint">प्रती,</span>&nbsp;</td></tr>
			<tr><td colspan="3" class="fontsize12"><span class="noprint">शाळा प्रमुख / मुख्याध्यापक</span>&nbsp;</td></tr>
			<tr>
				<td colspan="2" >
					<table width="1100" cellspacing="0">
						<tr>
							<td width ="450" class="fontsize10"><span class="noprint">शाळेचे नाव</span>&nbsp;</td>
							<td width ="650" class="fontsize15"><%=sectionWiseItemSum.getSchoolMarathi() %></td>
						</tr>
					</table>
				</td>
				<td>&nbsp;</td>
			...
			<tr>
				<td colspan="2" >
					<table width="1100"  cellspacing="0">
						<tr>
							<td width ="450" class = "fontsize10" height="15"><span class="noprint">तालुका</span>&nbsp;</td>
							<td width ="300" class="fontsize15"><%=talukaOrderHelper.getTalukaName()%></td>
							<td width ="250" class = "fontsize10" ><span class="noprint">जिल्हा</span>&nbsp;</td>
							<td width ="100" class="fontsize15"><%=talukaOrderHelper.getDistrictName()%></td>
						</tr>
					</table>
				</td>
				<td>&nbsp;</td>
			...
			<tr>
				<td colspan="2" >
					<table cellspacing="0">
						<tr>
							<td width ="450" class="fontsize10"><span class="noprint">आपल्या मागणीनुसार आपणांस माहे </span>&nbsp;</td>
							<td width ="650" class="fontsize15" height="30"><%=talukaOrderHelper.getFromMonth() %>-<%=talukaOrderHelper.getFromYear() %> व <%=talukaOrderHelper.getToMonth() %>-<%=talukaOrderHelper.getToYear() %> <span class="noprint fontsize10"> करिता </span></td>
						</tr>
					</table>
				</td>
				<td>&nbsp;</td>
			...
			<tr>
				<td colspan="2" >
					<table cellspacing="0">
						<tr>
							<td width ="10" ><span class="fontsize10 noprint">इयत्ता</span></td>
							<td width ="2000" class="fontsize15"> <%=talukaOrderHelper.getOrderTypeDetails() %> <span class="fontsize10 noprint"> साठी खालील तपशिलाप्रमाणे शालेय पोषण आहार योजनेअंतर्गत धान्यादी वस्तुंचा पुरवठा करण्यात आला आहे. </span></td>
						</tr>
					</table>
				</td>
			</tr>
				...
				<td colspan="2" >
					<table cellspacing="0">
						<tr height="20">
	                         ...
	                         <th width="100" ><span class="fontsize14 noprint">अ. क्र.</span></th>
	                         <th width="200" ><span class="fontsize14 noprint">पुरवठा प्रकार</span></th>
	                         <th width="200" colspan="2"><span class="fontsize14 noprint">एकूण पुर-वठा(किलो)</span></th>
	                    </tr>
	                    <tr>
	                         <td width="100" class="center"><span class="fontsize14 noprint">1</span></td>
	                         ...
	                         <td width="100" class="center"><span class="fontsize14 noprint">7</span></td>
	                         <td width="200" class="center"><span class="fontsize14 noprint">मीठ (आयोडिनयुक्त)</span></td>
	                         <td width="60" class="right"><span class="fontMarathiNumber16"><%=(long)(sectionWiseItemSum.getMith()) %></span></td>
	                         <td width="90" class="left"><span class="fontMarathiNumber16">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<% if((sectionWiseItemSum.getMith()-(long)sectionWiseItemSum.getMith())*1000 == 0){out.print("000");}else{out.print(Math.round((sectionWiseItemSum.getMith()-(long)sectionWiseItemSum.getMith())*1000));} %></span></td>
	                    </tr>
	                    <tr>
	                         ...
	                         <td width="100" class="center"><span class="fontsize14 noprint">8</span></td>
	                         <td width="200" class="center"><span class="fontsize14 noprint">कांदा लसूण मसाला</span></td>
	                         <td width="60" class="right"><span class="fontMarathiNumber16"><%=(long)(sectionWiseItemSum.getMirchi()) %></span></td>
	                         <td width="90" class="left"><span class="fontMarathiNumber16">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<% if((sectionWiseItemSum.getMirchi()-(long)sectionWiseItemSum.getMirchi())*1000 == 0){out.print("000");}else{out.print(Math.round((sectionWiseItemSum.getMirchi()-(long)sectionWiseItemSum.getMirchi())*1000));} %></span></td>
	                    </tr>
	                    <tr>
	                         ...
	                         <td width="100" class="center"><span class="fontsize14 noprint">9</span></td>
	                         <td width="200" class="center"><span class="fontsize14 noprint">हळद (अॅगमार्क)</span></td>
	                         <td width="60" class="right"><span class="fontMarathiNumber16"><%=(long)(sectionWiseItemSum.getHalad()) %></span></td>
	                         <td width="90" class="left"><span class="fontMarathiNumber16">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<% if((sectionWiseItemSum.getHalad()-(long)sectionWiseItemSum.getHalad())*1000 == 0){out.print("000");}else{out.print(Math.round((sectionWiseItemSum.getHalad()-(long)sectionWiseItemSum.getHalad())*1000));} %></span></td>
	                    </tr>
	                    <tr>
	                         ...
	                         <td width="100" class="center"><span class="fontsize14 noprint">10</span></td>
	                         <td width="200" class="center"><span class="fontsize14 noprint">जिरे</span></td>
	                         <td width="60" class="right"><span class="fontMarathiNumber16"><%=(long)(sectionWiseItemSum.getJire()) %></span></td>
	                         <td width="90" class="left"><span class="fontMarathiNumber16">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<% if((sectionWiseItemSum.getJire()-(long)sectionWiseItemSum.getJire())*1000 == 0){out.print("000");}else{out.print(Math.round((sectionWiseItemSum.getJire()-(long)sectionWiseItemSum.getJire())*1000));} %></span></td>
	                    </tr>
	                    <tr>
	                         ...
	                         <td width="100" class="center"><span class="fontsize14 noprint">11</span></td>
	                         <td width="200" class="center"><span class="fontsize14 noprint">मोहरी</span></td>
	                         <td width="60" class="right"><span class="fontMarathiNumber16"><%=(long)(sectionWiseItemSum.getMohari()) %></span></td>
	                         <td width="90" class="left"><span class="fontMarathiNumber16">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<% if((sectionWiseItemSum.getMohari()-(long)sectionWiseItemSum.getMohari())*1000 == 0){out.print("000");}else{out.print(Math.round((sectionWiseItemSum.getMohari()-(long)sectionWiseItemSum.getMohari())*1000));} %></span></td>
	                    </tr>	  
	                    <tr>
	                         ...
	                         <td width="75" class="right"><span class="fontMarathiNumber16"><%=threeDecimalFormatter.format(sectionWiseItemSum.getTel()) %></span></td>
	                         <td width="25" class="right"><span class="fontMarathiNumber16"></span></td>
	                         <td width="100" class="center"><span class="fontsize14 noprint"></span></td>
	                         <td width="200" class="center"><span class="fontsize14 noprint"></span></td>
	                         <td width="60" class="right"><span class="fontMarathiNumber16"></span></td>
	                         <td width="90" class="left"><span class="fontMarathiNumber16"></span></td>
	                   </tr>  
		             </table> 		             
		         </td> 
				 <td>&nbsp;</td>
