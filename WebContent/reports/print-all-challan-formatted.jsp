...
<html lang="mr">
    <head>
        ...
        <style type="text/css">
            ...
            .fontMarathiNumber16 {
                font:normal normal bold 16px/16px Kiran,Tahoma;
                text-decoration:none;
                margin: 0px;
                padding:0px;
            }
        ...
        <table align="center" width="1200">  
	            ...
	            <td width="300">
	            	<table>
	            		<tr>
		            		...
		            		<td width="350" class="right">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="fontsize16"><font face="Kiran"><%=dd%></font>/<font  face="Kiran"><%=mm%></font>/<font face="Kiran"><%=yy%></font></span></td>
	            		</tr>
	            	</table>
	            </td>
			</tr>
			<tr>
				<td colspan="3" class="fontsize10"><span class="noprint">प्रती,</span>&nbsp;</td>
			</tr>
			<tr>
				<td colspan="3" class="fontsize10" height="10"><span class="noprint">शाळा प्रमुख / मुख्याध्यापक</span>&nbsp;</td>
			</tr>
			<tr>
				<td colspan="2" >
				...
				<td colspan="2" >
					<table width="900"  cellspacing="0">
						<tr>
							...
							<td width ="250" class="fontsize15 right"><%=talukaOrderHelper.getDistrictName()%></td>
						</tr>
					</table>
				</td>
				<td>&nbsp;</td>
			...
			<tr>
				<td colspan="3" >
					<table cellspacing="0">
						<tr>
							<td width ="0" ><span class="fontsize10 noprint">इयत्ता</span></td>
			...
			<tr>
				<!--<td colspan="3" class="fontsize15">मागील ओर्डर चे खाली बारदान _______________________ नग पुरवठादाराला दिले </td>-->
				<td colspan="3" class="fontsize15">&nbsp;</td>
			</tr>
	    </table> 
        <p class="breakhere"></p>
<%
...
%>   			
    	...
    	<table align="center" border=0>  
			...
			<tr>
				...
				<th width="50">&nbsp;</th>
				<th width="250">&nbsp;</th>
				<th width="150" class="right"><span class="fontsize16"><font face="Kiran"><%=dd%></font>/<font  face="Kiran"><%=mm%></font>/<font face="Kiran"><%=yy%></font></span></th>
			</tr>
			-->
			<tr>		
	            <td colspan="1"></td>
	            ...
	            <td colspan="5">
				</td><td class="center"><span class="fontMarathiNumber16"><font face="Kiran"><%=dd%></font>/<font  face="Kiran"><%=mm%></font>/<font face="Kiran"><%=yy%></font></span></td>
			</tr>
			<tr><td class="fontsize12" style="height: 40px;"><span class="noprint">प्रती,</span>&nbsp;</td></tr>
			<tr><td class="fontsize12"><span class="noprint">शाळा प्रमुख / मुख्याध्यापक</span>&nbsp;</td></tr>
			<tr>
				<td colspan="2"><td colspan="5" class="fontsize15"><%=sectionWiseItemSum.getSchoolMarathi() %></td></td>
			</tr>
			<tr>
				<td colspan="2">
			...
			<tr>
				<td colspan="2">
					<td colspan="4" class="fontsize15" height=""><%=talukaOrderHelper.getFromMonth() %>-<%=talukaOrderHelper.getFromYear() %> व <%=talukaOrderHelper.getToMonth() %>-<%=talukaOrderHelper.getToYear() %> <span class="noprint fontsize10"> करिता </span></td>
				</td>
			</tr>
			<tr>
			...
			<tr>
				<td colspan="2">
					<td class="fontsize15" height="20"> <%if(sectionWiseItemSum.getTruckNo() != null){out.print(sectionWiseItemSum.getTruckNo());}else{out.print("");} %>	<span class="fontsize10 noprint">मधुन करण्यात आला आहे.</span></td>
				</td>
			</tr>			
			...
			<tr>
				...
				<td colspan="3">
					<td class="left">
						<span class="fontMarathiNumber16"><%=(long)(sectionWiseItemSum.getTel()) %>&nbsp;&nbsp;&nbsp;&nbsp;</span>
						<span class="fontMarathiNumber16"><% if((sectionWiseItemSum.getTel()-(long)sectionWiseItemSum.getTel())*1000 == 0){out.print("000");}else{out.print(Math.round((sectionWiseItemSum.getTel()-(long)sectionWiseItemSum.getTel())*1000));} %></span>
					</td>
				</td>
			</tr>
			<tr>
			...
			<tr>
				<td colspan="2">
					<td class="left">
						<span class="fontMarathiNumber16"><%=(long)(sectionWiseItemSum.getHarbara()) %>&emsp;&nbsp;</span>
					</td>
				</td>
				<td colspan="3">
					<td class="left">
			...
			<tr>
				<td colspan="2">
					<td class="left">
						<span class="fontMarathiNumber16"><%=(long)(sectionWiseItemSum.getVatana()) %>&emsp;&nbsp;</span>
					</td>
				</td>
				<td colspan="3">
					<td class="left">
			...
			<tr>
				...
				<td colspan="3">
					<td class="left">
						<span class="fontMarathiNumber16"><%=(long)(sectionWiseItemSum.getExtra1()) %></span>
						<span class="fontMarathiNumber16">&nbsp;&nbsp;&nbsp;&nbsp;<% if((sectionWiseItemSum.getExtra1()-(long)sectionWiseItemSum.getExtra1())*1000 == 0){out.print("000");}else{out.print(Math.round((sectionWiseItemSum.getExtra1()-(long)sectionWiseItemSum.getExtra1())*1000));} %></span>
					</td>
				</td>
		   </tr>
			...
			<tr>
				<td colspan="2">
					<td class="left">
						<span class="fontMarathiNumber16"><%=(long)(sectionWiseItemSum.getExtra2()) %>&emsp;&nbsp;</span>
					</td>
				</td>
				<td colspan="3">
					<td class="left">
						<span class="fontMarathiNumber16"><%=(long)(sectionWiseItemSum.getExtra3()) %></span>
						<span class="fontMarathiNumber16">&nbsp;&nbsp;&nbsp;&nbsp;<% if((sectionWiseItemSum.getExtra3()-(long)sectionWiseItemSum.getExtra3())*1000 == 0){out.print("000");}else{out.print(Math.round((sectionWiseItemSum.getExtra3()-(long)sectionWiseItemSum.getExtra3())*1000));} %></span>
					</td>
				</td>
		   </tr>
			<tr>
				<td colspan="2">
					<td class="left">
						<span class="fontMarathiNumber16"><%=(long)(sectionWiseItemSum.getExtra4()) %>&emsp;&nbsp;</span>
					</td>
				</td>
				<td colspan="3">
					<td class="left">
						<span class="fontMarathiNumber16"><%=(long)(sectionWiseItemSum.getExtra5()) %></span>
						<span class="fontMarathiNumber16">&nbsp;&nbsp;&nbsp;&nbsp;<% if((sectionWiseItemSum.getExtra5()-(long)sectionWiseItemSum.getExtra5())*1000 == 0){out.print("000");}else{out.print(Math.round((sectionWiseItemSum.getExtra5()-(long)sectionWiseItemSum.getExtra5())*1000));} %></span>
					</td>
				</td>
		   </tr>
			<tr>
				<td colspan="2">
					<td class="left">
						<span class="fontMarathiNumber16"><%=(long)(sectionWiseItemSum.getExtra6()) %>&emsp;&nbsp;</span>
					</td>
				</td>
				<td colspan="3">
					<td class="left">
			...
			<!--
			<tr>
				<td colspan="3">मागील ओर्डर चे खाली बारदान _______________________ नग पुरवठादार दिले </td>
			</tr>
			-->
	    </table> 
        <p class="breakhere"></p>
