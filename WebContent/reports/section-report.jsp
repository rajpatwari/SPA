...
<html lang="mr">
    <head>
        ...
        <%
                    ...
                    int tID = Integer.parseInt(sectionID);
                    int i = 0;
                    ...
                    Section s = DM.getSectionDetails(Integer.parseInt(sectionID));
                    TalukaOrder talukaOrderHelper = dSHelper.talukaOrderDetails(tOrderID);
                    
                    ArrayList<SectionWiseItemSum> sectionOrder = DS.getAllBeatForOrder(tID,tOrderID);
        %>
    ...
    <body>
        ...
        <p align="center"> शालेय पोषण आहार पुरवठा पंचायत समिती <%=talukaOrderHelper.getTalukaName()%>, जि. <%=talukaOrderHelper.getDistrictName()%> <br/>
            ...
            विभाग गोषवारा - <%=s.getSectionMarathi()%></p>
    ...
    %>
                <tr>
                    ...
                    <th ><%=sectionWiseItemSum.getBeatMarathi() %></th>
