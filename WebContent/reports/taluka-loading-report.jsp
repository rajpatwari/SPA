...
-->
            ...
            <tbody>
                ...
                <tr>
                    <th >१ गोनीचे वजन</th>
                    <th class="fontMarathiNumber"><%=0%></th>
                    <th class="fontMarathiNumber"><%=0%></th>
                    <th class="fontMarathiNumber"><%=0%></th>
                    <th class="fontMarathiNumber"><%=0%></th>
                    <th class="fontMarathiNumber"><%=0%></th>
...
-->
                    ...
                    <th class="fontMarathiNumber"><%=threeDecimalFormatter.format(allSum.getMirchi()) %></th>
                    <th class="fontMarathiNumber"><%=threeDecimalFormatter.format(allSum.getHalad()) %></th>
                    <th class="fontMarathiNumber"><%=threeDecimalFormatter.format(allSum.getJire()) %></th>
                    <th class="fontMarathiNumber"><%=threeDecimalFormatter.format(allSum.getMohari() )%></th>
                </tr>
                <tr>
...
-->
                    ...
                    <th class="fontMarathiNumber"><%=threeDecimalFormatter.format(allSum.getMirchi()/1000) %></th>
                    <th class="fontMarathiNumber"><%=threeDecimalFormatter.format(allSum.getHalad()/1000) %></th>
                    <th class="fontMarathiNumber"><%=threeDecimalFormatter.format(allSum.getJire()/1000) %></th>
                    <th class="fontMarathiNumber"><%=threeDecimalFormatter.format(allSum.getMohari()/1000)%></th>
                </tr>
    ...
    %>
            ...
            <tbody>
                ...
                <tr>
                    <th class="fontMarathiNumber">एकुण वजन (किलो)</th>
                    <th class="fontMarathiNumber"><%=threeDecimalFormatter.format(allSum.getTandul()) %></th>
                </tr>
                <tr>
                    <th class="fontMarathiNumber">एकुण वजन (क्विंटल)</th>
                    <th class="fontMarathiNumber"><%=threeDecimalFormatter.format(allSum.getTandul()/1000) %></th>
                </tr>
