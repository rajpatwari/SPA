...
<%
     ...
     int rootID = Integer.parseInt(request.getParameter("rootMasterID"));
     ...
     ArrayList<SectionWiseItemSum> sectionOrder = DS.getAllOrderWiseSchoolDetailsByRoot(tOrderID, rootID);  
%>
	    <p align="center"> शालेय पोषण आहार पुरवठा पंचायत समिती <%=talukaOrderHelper.getTalukaName()%>, जि. <%=talukaOrderHelper.getDistrictName()%> <br/>
	        ...
	        तालुका - <%=talukaOrderHelper.getTalukaName()%></p>
<%        
	if( orderType == 2 )
	{
%>
