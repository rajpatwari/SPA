...
<html>
    <head>
        ...
        <title>SHALEY POSHAN AHAR - Route Master</title>
        ...
        <style type="text/css">
            ...
            #root button{color: red;opacity: 0.5;pointer-events: none;}
        ...
        <!-- Data File -->
        <script type="text/javascript" src="JS/root_masters.js"></script>
    </head>
    <body>
        <div id="el1" style="padding: 10px;" class="x-hide-display">
            ...
            <label id="mlabel">Master Module - Route Master</label>
