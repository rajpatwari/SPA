...
var DistrictBillDatePreviewWin;
...
Ext.onReady(function()
{
    ...
    allSectionOrderStore= new Ext.data.JsonStore(
    {
        ...
        fields: ['sectionID','sectionMarathi','mungdaal','matki','mung','masuldaal','chvli','tel','mith','mirchi','halad','jire','mohari','tandul','harbara','vatana','extra1','extra2','extra3','extra4','extra5','extra6'],
        sortInfo: 
        {
            field:'sectionID',
            direction:'DESC'
    ...
    allBeatOrderStore= new Ext.data.JsonStore(
    {
        ...
        totalProperty: 'totalElements',
        idProperty : 'beatID',
        fields: ['beatID','beatMarathi','mungdaal','matki','mung','masuldaal','chvli','tel','mith','mirchi','halad','jire','mohari','tandul','harbara','vatana','extra1','extra2','extra3','extra4','extra5','extra6'],
        sortInfo: 
        {
            field:'beatID',
            direction:'DESC'
    ...
    allSchoolReturnStore = new Ext.data.JsonStore(
    {
        ...
        fields: ['talukaOrderDetailsId','beatID','schoolID','schoolMarathi',
                 ...
                 'omith','omirchi','ohalad','ojire','omohari','otandul','oharbara','ovatana','oextra1','oextra2','oextra3','oextra4','oextra5','oextra6'],
        sortInfo:
        {
            field:'schoolID',
            direction:'ASC'
    ...
    allSchoolOrderStore = new Ext.data.JsonStore(
    {
        ...
        fields: ['talukaOrderDetailsId','beatID','schoolID','schoolMarathi','challanNumber','challanDate','mungdaal','matki','mung','masuldaal','chvli','tel','mith','mirchi','halad','jire','mohari','tandul','harbara','vatana','extra1','extra2','extra3','extra4','extra5','extra6'],
        sortInfo:
        {
            field:'schoolID',
            direction:'ASC'
    ...
    talukaListStore = new Ext.data.JsonStore(
    {
        storeId: 'talukaListStore',
        url: 'read/get-all-taluka-list-by-dist-order.jsp',
        root: 'root',
        idProperty : 'talukaID',
        fields: ['talukaID','talukaMarathi'],
        sortInfo: 
        {
            field:'talukaID',
            direction:'DESC'
...
//        },
        ...
        tbar: [
        {
            ...
            handler : function()
            {
                ...
                var s13 = sel[0].get('harbara');
                var s14 = sel[0].get('vatana');
                var s15 = sel[0].get('extra1');
                var s16 = sel[0].get('extra2');
                var s17 = sel[0].get('extra3');
                var s18 = sel[0].get('extra4');
                var s19 = sel[0].get('extra5');
                var s20 = sel[0].get('extra6');
                Ext.Msg.alert(s1);
                if( s1 == 0 && s2 == 0 && s3 == 0 && s4 == 0 && s5 == 0 && s6 == 0 && s7 == 0 && s8 == 0 && s9 == 0 && s10 == 0 && s11 == 0 && s12 == 0 && s13 == 0 && s14 == 0 && s15 == 0 && s16 == 0 && s17 == 0 && s18 == 0 && s19 == 0 && s20 == 0) 
                {
    ...
    showAllTalukaOrderDetails = function()
    {
        ...
        {            
            ...
            cm1.setHidden(22,false);
            cm1.setHidden(23,false);
			cm1.setHidden(24,false);
			cm1.setHidden(25,false);
            cm1.setHidden(26,true);
        }
        else
        {            
            ...
            cm1.setHidden(19,true);
            cm1.setHidden(20,true);// तेल
            cm1.setHidden(21,true);
            cm1.setHidden(22,true);
            cm1.setHidden(23,true);
            cm1.setHidden(24,true);
            cm1.setHidden(25,true);
            cm1.setHidden(26,false);
        }
    ...
    showAllTalukaReturnDetails = function()
    {
        ...
        else
        {
            ...
            cm1.setHidden(18,true);// तेल
            cm1.setHidden(19,true);
            cm1.setHidden(20,true);
            cm1.setHidden(21,true);
            cm1.setHidden(22,true);
            cm1.setHidden(23,true);
            cm1.setHidden(24,false);
        ...
        openSchoolReturnWin(schoolWiseReturnGridEditable, title,350,1800);                             
    ...
    showAllBeatOrder = function()
    {
        ...
        {   
            ...
            cm.setHidden(19,false);
            cm.setHidden(20,false);
            cm.setHidden(21,false);
            cm.setHidden(22,true);
        }
        else
        {
            cm.setHidden(3,true);
    ...
    dOrders = new Ext.grid.GridPanel(
    {
        ...
        },'->',
        {
            ...
            handler: function()
            {
            	addSalesBillForm.getForm().reset();
            	allTalukaRationBillStore.load();
            	allTalukaTandulBillStore.load();
            	allDistrictTandulBillStore.load();   
            	allDistrictTandulSalesBillStore.load();
            	allDistrictRationSalesBillStore.load();
            	openAllBillWin();
            }
        },'-',
        {
            ...
            handler: function()
            {
                ...
                getDistrictBillDatePreviewWin();
                orderID = sel[0].get('orderID');
                districtID = sel[0].get('districtID');

                previewParam1 = "orderID="+orderID+"&districtID="+districtID;//+"&orderType="+orderType;
                Ext.getCmp('billPreviewDate1').reset();
               // Ext.getCmp('billPreviewDate').setValue(talukaInvoiceDate);
                DistrictBillDatePreviewWin.show();
                //allBillStore.reload();
            }
        },'-',
        {
    ...
    bOrders = new Ext.grid.GridPanel(
    {
        ...
        }, '-',
        {
            ...
            handler: function()
            {
                ...
                beatMarathi = sel[0].get('beatMarathi');
                var param = "talukaOrderID="+talukaOrderId+"&beatID="+beatID+"&orderType="+orderType;
                window.open("reports/bill-report.jsp?"+param,'sectionreport',"width=1500,height=800,top=40,left=60,menubar=1,resizable=0,location=1,scrollbars=1");
            }
        }, '-',
        {
            iconCls: 'printerall',
        ...
        }, '-',
        {
            ...
            handler: function(){
				...
				beatMarathi = sel[0].get('beatMarathi');
				var param = "talukaOrderID="+talukaOrderId+"&beatID="+beatID+"&orderType="+orderType;
				window.open("reports/print-all-challan-bills.jsp?"+param,'sectionreport',"width=1500,height=800,top=40,left=60,menubar=1,resizable=0,location=1,scrollbars=1");
            }
        }, '-',{
            iconCls: 'printerall',
            text: 'Transport Copy Print',
            handler: function(){
				var sm = bOrders.getSelectionModel();
				var sel = sm.getSelections();
				if(sel.length == 0)
				...
				beatMarathi = sel[0].get('beatMarathi');
				var param = "talukaOrderID="+talukaOrderId+"&beatID="+beatID+"&orderType="+orderType;
				window.open("reports/print-all-challan-transport-copy.jsp?"+param,'sectionreport',"width=1500,height=800,top=40,left=60,menubar=1,resizable=0,location=1,scrollbars=1");
            }
        }, '-',
        {
            xtype:'splitbutton',
        ...
        win = new Ext.Window(
        {
            ...
            buttons:[
            {
                ...
                handler:function()
                {
                    ...
                    {
                        var rec = updatedRecords[j];     
                        if(rec.data.mungdaal > rec.data.omungdaal || rec.data.mungdaal < (rec.data.omungdaal*-1))
                    	{
                        	Ext.Msg.alert('Error', rec.data.schoolMarathi + ' शाळेच्या <b>मुंगदाल</b>ची परतीच्या मालाचे वजन (<b>'+rec.data.mungdaal+'</b>) केलेल्या मागणी(<b>'+rec.data.omungdaal+'</b>) आहे');
                            return;
                    	}
                        if(rec.data.matki > rec.data.omatki || rec.data.matki < rec.data.omatki*-1)
                    	{
                        	Ext.Msg.alert('Error', rec.data.schoolMarathi + ' शाळेच्या <b>तुर डाळ</b>ची परतीच्या मालाचे वजन (<b>'+rec.data.matki+'</b>) केलेल्या मागणी(<b>'+rec.data.omatki+'</b>) आहे');
                            return;
                    	}
                        if(rec.data.mung > rec.data.omung || rec.data.mung < rec.data.omung*-1)
                    	{
                        	Ext.Msg.alert('Error', rec.data.schoolMarathi + ' शाळेच्या <b>मुंग</b>ची परतीच्या मालाचे वजन (<b>'+rec.data.mung+'</b>) केलेल्या मागणी(<b>'+rec.data.omung+'</b>) आहे');
                            return;
                    	}
                        if(rec.data.masuldaal > rec.data.omasuldaal || rec.data.masuldaal < rec.data.omasuldaal*-1)
                    	{
                        	Ext.Msg.alert('Error', rec.data.schoolMarathi + ' शाळेच्या <b>मसूरदाल</b>ची परतीच्या मालाचे वजन (<b>'+rec.data.masuldaal+'</b>) केलेल्या मागणी(<b>'+rec.data.omasuldaal+'</b>) आहे');
                            return;
                    	}
                        if(rec.data.harbara > rec.data.oharbara || rec.data.harbara < rec.data.oharbara*-1)
                    	{
                        	Ext.Msg.alert('Error', rec.data.schoolMarathi + ' शाळेच्या <b>हरभरा</b>ची परतीच्या मालाचे वजन (<b>'+rec.data.harbara+'</b>) केलेल्या मागणी(<b>'+rec.data.oharbara+'</b>) आहे');
                            return;
                    	}
                        if(rec.data.vatana > rec.data.ovatana || rec.data.vatana < rec.data.ovatana*-1)
                    	{
                        	Ext.Msg.alert('Error', rec.data.schoolMarathi + ' शाळेच्या <b>वटाणा</b>ची परतीच्या मालाचे वजन (<b>'+rec.data.vatana+'</b>) केलेल्या मागणी(<b>'+rec.data.ovatana+'</b>) आहे');
                            return;
                    	}
                        if(rec.data.extra1 > rec.data.oextra1 || rec.data.extra1 < rec.data.oextra1*-1)
                    	{
                        	Ext.Msg.alert('Error', rec.data.schoolMarathi + ' शाळेच्या <b>सोया वडी</b>ची परतीच्या मालाचे वजन (<b>'+rec.data.extra1+'</b>) केलेल्या मागणी(<b>'+rec.data.oextra1+'</b>) आहे');
                            return;
                    	}
                        if(rec.data.extra2 > rec.data.oextra2 || rec.data.extra2 < rec.data.oextra2*-1)
                    	{
                        	Ext.Msg.alert('Error', rec.data.schoolMarathi + ' शाळेच्या <b>extra2</b>ची परतीच्या मालाचे वजन (<b>'+rec.data.extra2+'</b>) केलेल्या मागणी(<b>'+rec.data.oextra2+'</b>) आहे');
                            return;
                    	}
                        if(rec.data.extra3 > rec.data.oextra3 || rec.data.extra3 < rec.data.oextra3*-1)
                    	{
                        	Ext.Msg.alert('Error', rec.data.schoolMarathi + ' शाळेच्या <b>extra3</b>ची परतीच्या मालाचे वजन (<b>'+rec.data.extra3+'</b>) केलेल्या मागणी(<b>'+rec.data.oextra3+'</b>) आहे');
                            return;
                    	}
                        if(rec.data.extra4 > rec.data.oextra4 || rec.data.extra4 < rec.data.oextra4*-1)
                    	{
                        	Ext.Msg.alert('Error', rec.data.schoolMarathi + ' शाळेच्या <b>extra4</b>ची परतीच्या मालाचे वजन (<b>'+rec.data.extra4+'</b>) केलेल्या मागणी(<b>'+rec.data.oextra4+'</b>) आहे');
                            return;
                    	}
                        if(rec.data.extra5 > rec.data.oextra5 || rec.data.extra5 < rec.data.oextra5*-1)
                    	{
                        	Ext.Msg.alert('Error', rec.data.schoolMarathi + ' शाळेच्या <b>extra5</b>ची परतीच्या मालाचे वजन (<b>'+rec.data.extra5+'</b>) केलेल्या मागणी(<b>'+rec.data.oextra5+'</b>) आहे');
                            return;
                    	}
                        if(rec.data.extra6 > rec.data.oextra6 || rec.data.extra6 < rec.data.oextra6*-1)
                    	{
                        	Ext.Msg.alert('Error', rec.data.schoolMarathi + ' शाळेच्या <b>extra6</b>ची परतीच्या मालाचे वजन (<b>'+rec.data.extra6+'</b>) केलेल्या मागणी(<b>'+rec.data.oextra6+'</b>) आहे');
                            return;
                    	}
                        if(rec.data.chvli > rec.data.ochvli || rec.data.chvli < rec.data.ochvli*-1)
                    	{
                        	Ext.Msg.alert('Error', rec.data.schoolMarathi + ' शाळेच्या <b>चावली</b>ची परतीच्या मालाचे वजन (<b>'+rec.data.chvli+'</b>) केलेल्या मागणी(<b>'+rec.data.ochvli+'</b>) आहे');
                            return;
                    	}
                        if(rec.data.tel > rec.data.otel || rec.data.tel < rec.data.otel * -1)
                    	{
                        	Ext.Msg.alert('Error', rec.data.schoolMarathi + ' शाळेच्या <b>तेल</b>ची परतीच्या मालाचे वजन (<b>'+rec.data.tel+'</b>) केलेल्या मागणी(<b>'+rec.data.otel+'</b>) आहे');
                            return;
                    	}
                        if(rec.data.mith > rec.data.omith || rec.data.mith < rec.data.omith * -1)
                    	{
                        	Ext.Msg.alert('Error', rec.data.schoolMarathi + ' शाळेच्या <b>मीठ</b>ची परतीच्या मालाचे वजन (<b>'+rec.data.mith+'</b>) केलेल्या मागणी(<b>'+rec.data.omith+'</b>) आहे');
                            return;
                    	}
                        if(rec.data.mirchi > rec.data.omirchi || rec.data.mirchi < rec.data.omirchi *-1)
                    	{
                        	Ext.Msg.alert('Error', rec.data.schoolMarathi + ' शाळेच्या <b>कांदा लसूण मसाला</b>ची परतीच्या मालाचे वजन (<b>'+rec.data.mirchi+'</b>) केलेल्या मागणी(<b>'+rec.data.omirchi+'</b>) आहे');
                            return;
                    	}
                        if(rec.data.halad > rec.data.ohalad || rec.data.halad < rec.data.ohalad*-1)
                    	{
                        	Ext.Msg.alert('Error', rec.data.schoolMarathi + ' शाळेच्या <b>हळद</b>ची परतीच्या मालाचे वजन (<b>'+rec.data.halad+'</b>) केलेल्या मागणी(<b>'+rec.data.ohalad+'</b>) आहे');
                            return;
                    	}
                        if(rec.data.jire > rec.data.ojire || rec.data.jire < rec.data.ojire *-1)
                    	{
                        	Ext.Msg.alert('Error', rec.data.schoolMarathi + ' शाळेच्या <b>जिरे</b>ची परतीच्या मालाचे वजन (<b>'+rec.data.jire+'</b>) केलेल्या मागणी(<b>'+rec.data.ojire+'</b>) आहे');
                            return;
                    	}
                        if(rec.data.mohari > rec.data.omohari || rec.data.mohari < rec.data.omohari*-1)
                    	{
                        	Ext.Msg.alert('Error', rec.data.schoolMarathi + ' शाळेच्या <b>मोहरी</b>ची परतीच्या मालाचे वजन (<b>'+rec.data.mohari+'</b>) केलेल्या मागणी(<b>'+rec.data.omohari+'</b>) आहे');
                            return;
                    	}
                        if(rec.data.tandul > rec.data.otandul || rec.data.tandul < (rec.data.otandul*-1))
                    	{
                        	Ext.Msg.alert('Error', rec.data.schoolMarathi + ' शाळेच्या <b>तांदूळ</b>ची परतीच्या मालाचे वजन (<b>'+rec.data.tandul+'</b>) केलेल्या मागणी(<b>'+rec.data.otandul+'</b>) आहे');
                            return;
                    	}
                        changedArray = changedArray.concat(Ext.util.JSON.encode(rec.data));
                        if(j!==(updatedRecords.length-1))
    ...
    allDistrictTandulBillStore = new Ext.data.JsonStore(
	{
        storeId: 'allDistrictTandulBillStore',
        url: 'read/get-all-district-tandul-bill.jsp',
        root: 'root',
        idProperty : 'invoiceID',
        fields: ['invoiceID','districtOrderNo','districtMarathi','invoiceIDMan','invoiceIDMan1','invoiceIDMan2','invoiceDate','districtOrderID','totalAmount1','totalAmount2','stdTypeDetails','orderType'],
        sortInfo: 
        {
            field:'invoiceID',
            direction:'DESC'
    ...
    allDistrictTandulSalesBillStore = new Ext.data.JsonStore(
	{
        storeId: 'allDistrictTandulSalesBillStore',
        url: 'read/get-all-district-tandul-sales-bill.jsp',
        root: 'root',
        idProperty : 'invoiceID',
        fields: ['invoiceID','districtMarathi','invoiceIDMan','invoiceIDMan1','invoiceIDMan2','invoiceDate','totalAmount','totalAmount1','totalAmount2','distOrder1to5Details','distOrder6to8Details','orderID','orderID1'],
        sortInfo: 
        {
            field:'invoiceID',
            direction:'DESC'
    ...
    allDistrictRationSalesBillStore = new Ext.data.JsonStore(
	{
        storeId: 'allDistrictRationSalesBillStore',
        url: 'read/get-all-district-ration-sales-bill.jsp',
        root: 'root',
        idProperty : 'invoiceID',
        fields: ['invoiceID','districtMarathi','invoiceIDMan','invoiceIDMan1','invoiceIDMan2','invoiceDate','totalAmount','totalAmount1','totalAmount2','distOrder1to5Details','distOrder6to8Details','orderID','orderID1'],
        sortInfo: 
    ...
    districtOrderList1to5 = new Ext.data.JsonStore(
    {
        //autoLoad: true,
        storeId: 'districtOrderList1to5',
        url: 'read/get-district-orders-list-by-stype-and-order-type.jsp',
        root: 'root',
        idProperty : 'orderID',
    ...
    districtOrderList6to8 = new Ext.data.JsonStore(
    {
        //autoLoad: true,
        storeId: 'districtOrderList6to8',
        url: 'read/get-district-orders-list-by-stype-and-order-type.jsp',
        root: 'root',
        idProperty : 'orderID',
        fields: ['orderID', 'orderNumber', 'orderNoDate'],
    ...
    //Start - Creates a grid for Taluka Bill
    ...
    //Start - Creates a grid for District Bill
    allDistrictTandulBillGrid = new Ext.grid.GridPanel(
    {
        store: allDistrictTandulBillStore,
        id: 'allDistrictTandulBillGrid',
        stripeRows: true,
        loadMask: true,
        columnLines: true,
        stateId: 'allDistrictTandulBillGrid',
        frame : true,
        tbar:[
        {
             text: ' प्रिंट बिल ',
             handler: function()
             {
                var sm = allDistrictTandulBillGrid.getSelectionModel();
                var sel = sm.getSelections();
                if(sel.length == 0)
                {
                    Ext.Msg.alert('Select Bill', 'No District Bill is selected!');
                    return;
                }
                var invoiceID = sel[0].get('invoiceID');
                var param = "invoiceID="+invoiceID;                
                window.open("reports/print-district-invoice.jsp?"+param,'districtBill',"width=1500,height=800,top=40,left=60,menubar=1,resizable=0,location=1,scrollbars=1");
            }
        },'->',
        {
            text:'Delete',
            ...
            handler: function()
            {
                ...
                {
                   title: 'Confirm Delete',
                   msg: 'Do you want to delete Bill No.<b>'+invoiceID+'</b>  for District: <b>'+ districtMarathi + '</b>',
                   buttons: Ext.MessageBox.YESNO,
                   fn: function(btn)
                   {
                       if(btn == "yes")
                       {
                           Ext.Ajax.request(
                           {
                               url: 'delete/delete-district-bill.jsp',
                               method:'POST',
                               params:{invoiceID:invoiceID},
                               success: function()
                               {
                                    Ext.Msg.alert("Deleted",'Taluka Bill Deleted');
                                    allDistrictTandulBillStore.reload(
                                    {
                                        waitMsg: 'Loading...'
                                    });
                                },
    ...
    //End - Creates a grid for District Bill
    
    //Start - Create add taluka order form
    addSalesBillForm = new Ext.FormPanel(
    {
        labelAlign: 'right',
        frame:true,
        id: 'addSalesBillForm',
        ...
        items: [
        {
            ...
            items:[
            {
                ...
                items: [    
                /*
                SELECT dm.`district_order_id`,dm.`district_gov_order_num`,dm.`district_id`,dms.`district_marathi`,tm.`order_type` 
				FROM `district_order` dm
				INNER JOIN `taluka_order` tm ON tm.`district_order_id` = dm.`district_order_id` AND tm.`order_type` = 1 AND tm.`deleted` <> 1
				INNER JOIN `district_master` dms ON dms.`district_id` = dm.`district_id` AND dms.`std_type` = 1
				GROUP BY dm.`district_order_id`
				
				
				SELECT dm.district_order_id,dm.district_gov_order_num,dm.district_id,dms.district_marathi,tm.order_type,
CONCAT('Order No :',CAST(dm.order_number AS CHAR),' ','-','Order Date','(',dm.`district_order_date`,')-') AS orderList  
FROM district_order dm
INNER JOIN taluka_order tm ON tm.district_order_id = dm.district_order_id AND tm.order_type = 1 AND tm.deleted <> 1
INNER JOIN district_master dms ON dms.district_id = dm.district_id AND dms.std_type = 1
GROUP BY dm.district_order_id
                ...
                */
                {
                    ...
                    listeners			: 	
                    {
                        ...
                        {
                        	Ext.getCmp('orde1to5').clearValue();
                        	Ext.getCmp('orde6to8').clearValue();
                        	districtOrderList1to5.load(
                			{
                                params				:	
                                {
                ...
                },   
                {
                    xtype			:	'combo',
                    id				: 	'orde1to5',
                    fieldLabel		: 	'1 to 5 District ऑर्डर#',                    
                    labelWidth		: 	200,
                    forceSelection 	: 	true,
                    allowBlank		: 	false,
                    triggerAction 	: 	'all',
                ...
                }, 
                {
                    xtype			:	'combo',
                    id				: 	'orde6to8',
                    fieldLabel		: 	'6 to 8 District ऑर्डर#',
		...
		{
			text			: 	'View Bill',
            id				:	'district-sales-bill-button',
            iconCls			:	'save',
		    scale			: 	'medium',
		    bodyStyle		: 	'padding: 0px 100px 100px',
		    handler			: 	function()
		    {
		        if(addSalesBillForm.getForm().findField( 'orderType' ).getValue() != 0 &&
                   addSalesBillForm.getForm().findField( 'orde1to5' ).getValue() != 0  &&
                   addSalesBillForm.getForm().findField( 'orde6to8' ).getValue() != 0 &&
                   addSalesBillForm.getForm().findField( 'salesBillDate' ).getValue() != 0 ) 
		        {
		        	orderType = addSalesBillForm.getForm().findField( 'orderType' ).getValue();
		        	orde1to5 = addSalesBillForm.getForm().findField( 'orde1to5' ).getValue();
		        	orde6to8 = addSalesBillForm.getForm().findField( 'orde6to8' ).getValue();
		        	salesBillDate = addSalesBillForm.getForm().findField( 'salesBillDate' ).getRawValue();
		        	if(orderType == 1)
		        		window.open("reports/preview-district-rice-for-both-stype-invoice.jsp?orderType="+orderType+"&orde1to5="+orde1to5+"&orde6to8=" +orde6to8+"&salesBillDate=" +salesBillDate,'district-order-dispatch-by-taluka-order-report',"width=1500,height=800,top=40,left=60,menubar=1,resizable=0,location=1,scrollbars=1");
		        	else
		        		window.open("reports/preview-district-ration-for-both-stype-invoice_update_lasun.jsp?orderType="+orderType+"&orde1to5="+orde1to5+"&orde6to8=" +orde6to8+"&salesBillDate=" +salesBillDate,'district-order-dispatch-by-taluka-order-report',"width=1500,height=800,top=40,left=60,menubar=1,resizable=0,location=1,scrollbars=1");
	                addSalesBillForm.getForm().reset();
		        }
		        else 
		        {
		            Ext.Msg.alert('Alert...','All Field must be selected..');
		        }
		    }
		},
        {
    ...
    //Start - Create add taluka order form
    coverLetterForm = new Ext.FormPanel(
    {
        labelAlign: 'right',
        frame:true,
        id: 'coverLetterForm',
        ...
        items: [
        {
            ...
            items:[
            {
                ...
                items: [  
                {
                    ...
                    id:'orderId1to5',
                    name:'orderId1to5',
                    fieldLabel:'orderId1to5'
                }, 
                {
                    xtype:'hidden',
                    id:'orderId6to8',
                    name:'orderId6to8',
                    fieldLabel:'orderId6to8'
                },
                {
                    xtype: 'combo',
                    id: 'talukaid',
        ...
        buttons: [
		{
            ...
            id				:	'district-cover-letter-button',
            iconCls			:	'save',
		    scale			: 	'medium',
		    bodyStyle		: 	'padding: 0px 100px 100px',
		    handler			: 	function()
		    {
		        if(coverLetterForm.getForm().findField('talukaid').getValue() != 0) 
		        {
		        	talukaid = coverLetterForm.getForm().findField('talukaid').getValue();
		        	orderId1to5 = coverLetterForm.getForm().findField( 'orderId1to5' ).getValue();
		        	orderId6to8 = coverLetterForm.getForm().findField( 'orderId6to8' ).getValue();
		        	var param = "talukaId="+talukaid+"&orderId1to5="+orderId1to5+"&orderId6to8="+orderId6to8;                
		            window.open("reports/print-district-rice-for-both-stype-cover-letter.jsp?"+param,'districtSalesBill',"width=1500,height=800,top=40,left=60,menubar=1,resizable=0,location=1,scrollbars=1");
		        }
		        else 
		        {
		            Ext.Msg.alert('Alert...','All Field must be selected..');
    ...
    //Start - Creates a grid for District Bill
    allDistrictTandulSalesBillGrid = new Ext.grid.GridPanel(
    {
        store: allDistrictTandulSalesBillStore,
        id: 'allDistrictTandulSalesBillGrid',
        stripeRows: true,
        loadMask: true,
        columnLines: true,
        stateId: 'allDistrictTandulSalesBillGrid',
        frame : true,
        tbar:[
        {
            ...
            {
            	//allDistrictStore.load();
                openWin(addSalesBillForm, 'Sales Bill',270,600);
            }
        },'->',
        {
            text: ' Cover Letter  ',
            handler: function()
            {																																																																																																																																																																																																																																																																			
               var sm = allDistrictTandulSalesBillGrid.getSelectionModel();
               var sel = sm.getSelections();
               if(sel.length == 0)
               {
                   Ext.Msg.alert('Select Bill', 'No District Bill is selected!');
               ...
               var distOrder1to5Details = sel[0].get('orderID');
               var distOrder6to8Details = sel[0].get('orderID1');
               talukaListStore.load(
    		   {
                   params				:	
                   {
                	   distOrder1to5			:	distOrder1to5Details,
                	   distOrder6to8			:	distOrder6to8Details
                   }
               });
               Ext.getCmp('orderId1to5').setValue(distOrder1to5Details);
               Ext.getCmp('orderId6to8').setValue(distOrder6to8Details);
               openWin(coverLetterForm, 'Cover Letter',200,300);
               /*var param = "invoiceID="+invoiceID;                
               window.open("reports/print-district-rice-for-both-stype-invoice.jsp?"+param,'districtSalesBill',"width=1500,height=800,top=40,left=60,menubar=1,resizable=0,location=1,scrollbars=1");*/
           }
        },'-','-',
        {
             text: ' प्रिंट बिल ',
        ...
        },'-','-',
        {
            ...
            handler: function()
            {
                ...
                if(sel == 0){Ext.Msg.alert('Warning','No Bill is selected');return;}
                var invoiceID = sel[0].get('invoiceID');
                var invoiceNo = sel[0].get('invoiceIDMan');
                var districtMarathi = sel[0].get('districtMarathi');
                Ext.MessageBox.show(
                {
                   title: 'Confirm Delete',
                   msg: 'Do you want to delete Bill No.<b>'+invoiceNo+'</b>  for District: <b>'+ districtMarathi + '</b>',
                   buttons: Ext.MessageBox.YESNO,
                   fn: function(btn)
                   {
                       if(btn == "yes")
                       {
                           Ext.Ajax.request(
                           {
                               url: 'delete/delete-district-sales-bill.jsp',
                               method:'POST',
                               params:{invoiceID:invoiceID},
                               success: function()
                               {
                                    Ext.Msg.alert("Deleted",'Taluka Bill Deleted');
                                    allDistrictTandulSalesBillStore.reload(
                                    {
                                        waitMsg: 'Loading...'
                                    });
                                },
  ...
  //Start - Creates a grid for District Bill
    allDistrictRationSalesBillGrid = new Ext.grid.GridPanel(
    {
        store: allDistrictRationSalesBillStore,
        id: 'allDistrictRationSalesBillGrid',
        stripeRows: true,
        loadMask: true,
        columnLines: true,
        stateId: 'allDistrictRationSalesBillGrid',
        frame : true,
        tbar:[
        {
        	text: 'Create Sales Bill',
        ...
        },'->',
        {
            ...
            handler: function()
            {																																																																																																																																																																																																																																																																			
               var sm = allDistrictRationSalesBillGrid.getSelectionModel();
               var sel = sm.getSelections();
               if(sel.length == 0)
               {
                   Ext.Msg.alert('Select Bill', 'No District Bill is selected!');
        ...
        },'-','-',
        {
             ...
             handler: function()
             {
                ...
                var invoiceID = sel[0].get('invoiceID');
                var param = "invoiceID="+invoiceID;                
                window.open("reports/print-district-ration-for-both-stype-invoice_update_lasun.jsp?"+param,'districtSalesBill',"width=1500,height=800,top=40,left=60,menubar=1,resizable=0,location=1,scrollbars=1");
            }
        },'-','-',
        {
            text:'Delete',
            ...
            handler: function()
            {
                ...
                if(sel == 0){Ext.Msg.alert('Warning','No Bill is selected');return;}
                var invoiceID = sel[0].get('invoiceID');
                var invoiceNo = sel[0].get('invoiceIDMan1');
                var invoiceNo1 = sel[0].get('invoiceIDMan2');
                var districtMarathi = sel[0].get('districtMarathi');
                Ext.MessageBox.show(
                {
                   title: 'Confirm Delete',
                   msg: 'Do you want to delete Bill No. <b>'+invoiceNo+'</b> And <b>'+invoiceNo1+'</b> for District: <b>'+ districtMarathi + '</b>',
                   buttons: Ext.MessageBox.YESNO,
                   fn: function(btn)
                   {
                       if(btn == "yes")
                       {
                           Ext.Ajax.request(
                           {
                               ...
                               {
                                    Ext.Msg.alert("Deleted",'Taluka Bill Deleted');
                                    allDistrictRationSalesBillStore.reload(
                                    {
                                        waitMsg: 'Loading...'
                                    });
                                },
        ...
        [
            ...
            {
                header: '<b>Non Taxable Bill No.</b>',
                width:'60',
                sortable: true,
                align: 'center',
                dataIndex:'invoiceIDMan2'
            ...
            {
                header: '<b>Taxable Bill Amount</b>',
                width:'150',
                sortable: true,
                align: 'center',
                dataIndex:'totalAmount1'
            ...
            {
                header: '<b>Non Taxable Bill Amount</b>',
                width:'150',
                sortable: true,
                align: 'center',
                dataIndex:'totalAmount2'
            ...
            items 			: 	[
            {
                ...
                items 			:	[
                {
                    ...
                    items			:	[  
                    {
                        ...
                        items 			:	[
                     	{
                     		title 			: 	'District Bill',	
                     		layout			: 	'fit',	
                     		items 			:	[allDistrictTandulBillGrid] 
                     	},
                        {
                        ...
                        {	
                     		title 			: 	'Tandul Sales Bill',
                     		layout			: 	'fit', 	
                     		items 			: 	[allDistrictTandulSalesBillGrid]
                     	},
                        {	
                     		title 			: 	'Ration Sales Bill',
                     		layout			: 	'fit', 	
                     		items 			: 	[allDistrictRationSalesBillGrid]
                     	}]
                    }]
                }]
            }]
  ...
  //returns all items to be added to form
    ...
    var frm1 = new Ext.FormPanel({
        ...
        buttons: [
        {
	        ...
	        handler: function()
	        {
	            var previewDate = Ext.getCmp('billPreviewDate1').value;
	            if (previewDate == undefined) 
	            {
	                Ext.Msg.alert("Alert...","Preview Date Field Cannot Be Left Blank...");
	            }
	            ...
	            {
	            	DistrictBillDatePreviewWin.hide();
	                previewParam1 = previewParam1 + "&previewDate=" + previewDate ;
	                window.open("reports/verify-dups-district-invoices.jsp?"+previewParam1,'bills',"width=1500,height=800,top=40,left=60,menubar=1,resizable=0,location=1,scrollbars=1");
	            }
	        }
	    }, 
	    {
  ...
  //FormPanel to add data to grid start
    ...
    getDistrictBillDatePreviewWin = function () 
    {
        //Window for adding data to the grid
        if (Ext.type(DistrictBillDatePreviewWin)) 
        {
            return DistrictBillDatePreviewWin;
        }
        DistrictBillDatePreviewWin = new Ext.Window(
        {
            id: 'DistrictBillDatePreviewWin',
            name: 'DistrictBillDatePreviewWin',
            autoHeight : true,
            width: 300,
            modal: true,
            autoDestroy: true,
