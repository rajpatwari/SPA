...
<html>
    <head>
        ...
        <title>SHALEY POSHAN AHAR - Dispatch Master</title>
        ...
        <script type="text/javascript" src="./resources/js/GroupSummary.js"></script>
    ...
    <body>
        <div id="el1" style="padding: 10px;" class="x-hide-display">
           ...
           <label id="mlabel">Dispatch Module</label>
