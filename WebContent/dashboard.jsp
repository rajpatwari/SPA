<%-- 
    Document   : dasboard
    Created on : Dec 31, 2012, 12:14:00 PM
    Author     : Anita
--%>
...
<html>
    <head>
        ...
        <title>SHALEY POSHAN AHAR - Dashboard</title>
            ...
            Ext.onReady(function()
            {
                ...
                [
                    ...
                    }),
                    {
                        ...
                        height:100,
                        layout:'fit',
                        style:'left: 50px; top: 35px;width:300px;',
                        items:[getWestDashboard()]
    ...
    <body>
        <div id="el1" style="padding: 10px;" class="x-hide-display">
            <img alt="SHALEY POSHAN AHAR SOFTWARE SYSTEM" src="resources/images/s.png" style="font-size:25px;font-weight:bold;color: #222297;">
            <a href="logout.jsp"> <img alt="" align="right" src="./resources/images/signout.png"></a>&nbsp;&nbsp;&nbsp;&nbsp;
        </div>

        <div id="el2" class="x-hide-display">
            <center><h3>Software developed and maintained by CurrentechSoftwares©, Pune<br/><a href="www.CurrentechSoftwares.com">www.CurrentechSoftwares.com</a></h3></center>
        </div>
    </body>
</html>
